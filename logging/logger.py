...
class Logger:
  def __init__(self, model_name, model, optimizer, train_eval, val_eval):
    ...
    dir_path = f"DRIVE_PATH/models/{self.model_name}/runs/{self.date.strftime('%m-%d')}/{self.date.strftime('%H:%M')}"
